...
import { cloneDeep, pickBy, pullAllWith, isEqual, identity } from 'lodash'
...
const PersonalForm = (props: any) => {
  const { extendData, isUserOnline } = props
  ...
  return (
    <div className="flex h-full flex-col px-8 py-12 min-h-[100vh] overflow-auto">
      ...
      <div className="flex justify-between items-center pt-8 pb-4">
        ...
        <div
          ...
          className="text-xs bg-[#F3F3F3] font-500 rounded-2xl px-4 py-1"
        >
      ...
      {coverImg && <img src={coverImg} style={{ borderRadius: 10 }} />}
      <div className="flex justify-between items-center pt-8 pb-4">
        <p>照片&视频</p>
        <div
          onClick={() => {
