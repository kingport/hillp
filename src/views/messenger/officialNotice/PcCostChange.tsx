  ...
  return (
    <div className="flex min-h-[calc(100vh-60px)] items-center justify-center">
      <div className={`flex flex-col items-center w-400px`}>
        ...
        <div className="shadow-sm flex justify-center py-4 w-[100%] -m-14 bg-[#fff] rounded-lg z-20">
        ...
        <div className="shadow-sm flex flex-col px-8 py-8 mb-4 w-[100%] mt-20 bg-[#fff] rounded-lg">
        ...
        <div className="shadow-sm flex flex-col px-8 py-8 mb-4 w-[100%] mt-4 bg-[#fff] rounded-lg">
          {/* 原成本 type==1 */}
        ...
        <div className="flex w-full justify-around">
          <Button
            onClick={turnDown}
            className=" bg-[#F3F3F3] w-180px h-[2.75rem]"
            type="submit"
            shape="rounded"
            loadingIcon={<></>}
          >
